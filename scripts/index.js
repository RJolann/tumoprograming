...
function generatePassword(length) {
  ...
  {
    let array = [] 
    if (shouldIncludeLowerCase()) array.push (randomLowerCase())
    if (shouldIncludeNumbers()) array.push (randomNumber())
    if (shouldIncludeSymbols()) array.push (randomSymbol())
    if (shouldIncludeUpperCase()) array.push (randomUpperCase())
   
    pass += arrayRandom(array)
  }
